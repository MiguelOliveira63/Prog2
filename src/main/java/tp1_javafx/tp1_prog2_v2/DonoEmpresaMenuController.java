...
public class DonoEmpresaMenuController {
    ...
    private void onEmpresaSelected(ActionEvent e) {
        ...
        empresaOptional.ifPresent(empresa -> {
            ...
            boolean mostrarControlesAdicionais = (nomeEmpresaSelecionada != null);
            nomeField.setVisible(mostrarControlesAdicionais);
            moradaField.setVisible(mostrarControlesAdicionais);
            localidadeField.setVisible(mostrarControlesAdicionais);
            telefoneField.setVisible(mostrarControlesAdicionais);
